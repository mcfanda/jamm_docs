...
Several bootstrap methods can be selected. One of the most used in mediation analysis is the _bias-corrected_ method, which is jAMM is called `bootstrap (BC)`. See here for help on the other options. Please note that the bootstrap method can be very time-consuming and slow.
